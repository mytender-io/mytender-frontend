...
import { Check, TextIcon } from "lucide-react";
...
const FullProposal = ({ handleTabClick }: FullProposalProps) => {
        ...
        {localLoading ? (
          ...
          <div className="space-y-2">
            <div className="flex gap-2 pr-4">
              ...
              >
                <div className="w-full max-w-4xl flex-1 mt-4">
                  {/* Buttons positioned above the editor, aligned to the right */}
                    ...
                    >
                      {outline.length > 0 ? (
                        ...
                        <div className="flex justify-center items-center h-full bg-muted p-5 text-center">
                          <p>
                            No sections found in the outline. Add sections in
                            the bid outline tab to start building your proposal.
                          </p>
                        </div>
                      )}
                      {/* Selection Menu */}
